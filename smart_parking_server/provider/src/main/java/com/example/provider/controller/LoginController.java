...
public class LoginController {
    ...
    public boolean parking_login(@PathVariable String pctr_id,@PathVariable String pctr_password){
        return false;
    }
    ...
    public boolean controller_login(@PathVariable String ctr_id,@PathVariable  String ctr_password){
        return false;
    }
